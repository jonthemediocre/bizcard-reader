...
const PersonalInfo: React.FC<PersonalInfoProps> = ({ businessCard }) => (
  <>
    <div className="px-4 py-5 sm:px-6">
      ...
      <p className="mt-1 max-w-2xl text-sm text-gray-500">
        Details extracted from the business card
      </p>
    </div>
